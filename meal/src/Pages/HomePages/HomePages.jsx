      ...
      <div className="menu">
        ...
        <div className="container">
          <ul className="menu-meal">
            <li className="meal"><a href="#" className="menu-link actives">Lavash</a></li>
            <li className="meal"><a href="#" className="menu-link">Desert</a></li>
            <li className="meal"><a href="#" className="menu-link">Set</a></li>
